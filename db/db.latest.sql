CREATE DATABASE  IF NOT EXISTS `drug_manager` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `drug_manager`;
-- MySQL dump 10.13  Distrib 5.6.24, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: drug_manager
-- ------------------------------------------------------
...
CREATE TABLE `user` (
  ...
  `access` int(11) DEFAULT '1' COMMENT 'Access 1 : Read , 2 : write',
  `first_name` varchar(45) DEFAULT NULL,
  `last_name` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Dumping routines for database 'drug_manager'
--
...
-- Dump completed on 2015-10-16  2:54:55
